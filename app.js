...
const MOTIVATIONS = [
  // Сила
  { text: "Настюша, ты сильнее, чем думаешь!", btn: "Я сильная!" },
  { text: "Каждый подход делает тебя сильнее, Настюш", btn: "Становлюсь сильнее" },
  { text: "Сила внутри тебя растёт, Настя", btn: "Чувствую её!" },
  { text: "Твоя сила вдохновляет", btn: "Я могу больше!" },
  { text: "Ты — сильная женщина, Настюша", btn: "Это я!" },
  { text: "Сила приходит к тем, кто не сдаётся", btn: "Не сдамся!" },
  { text: "Сила — это привычка. И она у тебя есть, Настя", btn: "Привыкла!" },
  { text: "Твои мышцы тебе благодарны, Настюш", btn: "Ещё разок!" },
  { text: "Сильные руки, сильный характер", btn: "Чувствую!" },
  { text: "Ты будишь свою силу, Настюша", btn: "Я готова!" },
  // Красота
  { text: "Ты становишься ещё красивее, Настюш", btn: "Спасибо!" },
  { text: "Тренировки делают тебя сияющей", btn: "Сияю!" },
  { text: "Красота в твоём упорстве, Настя", btn: "Иду до конца!" },
  { text: "Ты светишься после тренировок, Настюша", btn: "Чувствую свет!" },
  { text: "Каждый подход — инвестиция в красоту", btn: "Инвестирую!" },
  { text: "Твоё тело преображается, Настюш", btn: "Вижу!" },
  { text: "Сильная и красивая — это ты", btn: "Это я!" },
  { text: "Спортивная фигура — твой выбор, Настя", btn: "Мой выбор!" },
  { text: "Красота требует усилий — и ты их прикладываешь", btn: "Знаю!" },
  { text: "Ты — ходячее вдохновение, Настюша", btn: "Спасибо!" },
  // Прогресс
  { text: "Настюша, ты ближе к цели, чем вчера", btn: "Иду к цели!" },
  { text: "Прогресс — это твой путь", btn: "Иду по нему!" },
  { text: "Каждый подход — шаг вперёд, Настя", btn: "Шагаю!" },
  { text: "Сегодня ты лучше, чем вчера, Настюш", btn: "Завтра ещё лучше!" },
  { text: "Маленькие шаги ведут к большим победам", btn: "Иду к победе!" },
  { text: "Настюша, ты на правильном пути", btn: "Знаю!" },
  { text: "Прогресс виден", btn: "Замечаю!" },
  { text: "Ещё чуть-чуть до цели, Настя", btn: "Достигну!" },
  { text: "Каждая тренировка приближает мечту", btn: "Близко!" },
  { text: "Видишь себя со стороны, Настюш? Ты крута!", btn: "Я крута!" },
  { text: "Ты выросла за эту тренировку, Настя", btn: "Чувствую!" },
  { text: "Каждый подход добавляет результат", btn: "Добавляю!" },
  { text: "Прогресс не ждёт. Он у тебя в руках, Настюша", btn: "В моих руках!" },
  { text: "Ты создаёшь будущую себя", btn: "Создаю!" },
  { text: "Будущая ты скажет тебе спасибо, Настя", btn: "Скажет!" },
  // Похвала
  { text: "Настюша, ты молодец!", btn: "Спасибо!" },
  { text: "Так держать, Настя!", btn: "Держу!" },
  { text: "Продолжай в том же духе, Настюш", btn: "Продолжаю!" },
  { text: "Отличная работа, Настюша!", btn: "Спасибо!" },
  { text: "Ты — огонь, Настя!", btn: "Я огонь!" },
  { text: "Невероятно!", btn: "Знаю!" },
  { text: "Браво, Настюша!", btn: "Спасибо!" },
  { text: "Это было круто, Настя", btn: "Я крутая!" },
  { text: "Идеально", btn: "Стараюсь!" },
  { text: "Ты королева, Настюш", btn: "Я королева!" },
  { text: "Ты горишь, Настя!", btn: "Чувствую!" },
  { text: "Восхищаюсь тобой, Настюша", btn: "Спасибо!" },
  { text: "Ты делаешь это", btn: "Я делаю!" },
  { text: "Класс, Настя!", btn: "Идём дальше!" },
  { text: "Респект тебе, Настюша", btn: "Принято!" },
  // Упорство
  { text: "Не сдавайся, Настюш, ты почти там", btn: "Не сдамся!" },
  { text: "Финишная прямая близко", btn: "Дойду!" },
  { text: "Ещё немного — и ты на вершине, Настя", btn: "Покорю!" },
  { text: "Сильные не сдаются, Настюша", btn: "Я сильная!" },
  { text: "Ты можешь больше, чем думаешь, Настя", btn: "Попробую!" },
  { text: "Усталость — это слабость, покидающая тело", btn: "Уходи!" },
  { text: "Сложно — значит ты растёшь, Настюш", btn: "Расту!" },
  { text: "Боль уходит, гордость остаётся", btn: "Готова!" },
  { text: "Не пропускай, Настя — будущая ты скажет спасибо", btn: "Делаю!" },
  { text: "Ты выбираешь себя сегодня, Настюша", btn: "Выбираю!" },
  { text: "Дисциплина равняется свободе", btn: "Свободна!" },
  { text: "Слабые жалуются, сильные действуют", btn: "Действую!" },
  { text: "Сила воли — твой второй мускул, Настя", btn: "Качаю!" },
  { text: "Настюш, ты не остановишься на полпути", btn: "Не остановлюсь!" },
  { text: "Отговорки или результат — ты выбрала результат, Настюша", btn: "Выбрала!" },
  // Вера
  { text: "Настюша, я в тебя верю", btn: "Я тоже!" },
  { text: "Ты можешь всё, Настя", btn: "Знаю!" },
  { text: "Невозможное — это просто непривычное", btn: "Привыкаю!" },
  { text: "Каждая чемпионка начинала с одного подхода, Настюш", btn: "Начала!" },
  { text: "Будь героиней своей истории, Настя", btn: "Я героиня!" },
  { text: "Ты вдохновляешь", btn: "Спасибо!" },
  { text: "Ты способна на большее, Настюша", btn: "Покажу!" },
  { text: "Сильные женщины меняют мир", btn: "Меняю!" },
  { text: "Ты создаёшь свою лучшую версию, Настя", btn: "Создаю!" },
  { text: "Настюш, ты не такая, как все. Ты — лучше", btn: "Спасибо!" },
  { text: "Ты выбираешь быть сильной, Настюша", btn: "Выбираю!" },
  { text: "Твоя сила — пример другим", btn: "Это я!" },
  { text: "Только вперёд, Настя!", btn: "Только так!" },
  { text: "Чемпионки тренируются даже когда не хотят, Настюш", btn: "Я чемпионка!" },
  { text: "Ты делаешь то, на что многие не решаются, Настя", btn: "Я смелая!" },
  // Конкретное
  { text: "Это был мощный подход, Настюша!", btn: "Дальше!" },
  { text: "Видела, как ты подняла, Настя? Огонь!", btn: "Огонь!" },
  { text: "Этот подход тебе зачёт", btn: "Спасибо!" },
  { text: "Ты сегодня в ударе, Настюша", btn: "В ударе!" },
  { text: "Подход в копилку", btn: "Копим!" },
  { text: "Один подход ближе к идеалу, Настя", btn: "Иду!" },
  { text: "Тебе это даётся всё легче, Настюш", btn: "Замечаю!" },
  { text: "Настюша, это твой день", btn: "Мой день!" },
  { text: "Ты только что стала сильнее, Настя", btn: "Чувствую!" },
  { text: "Настюш, ты сегодня себя удивляешь", btn: "Удивляюсь!" },
  // Восторг
  { text: "Ура, Настюша! Ещё один подход", btn: "Ура!" },
  { text: "Йес! Так держать, Настя", btn: "Йес!" },
  { text: "Wow, Настюша, как круто!", btn: "Спасибо!" },
  { text: "Воу-воу, какая ты, Настя!", btn: "Какая есть!" },
  { text: "Огонь!", btn: "Жгу!" },
  { text: "Бомбически, Настюша", btn: "Бомба!" },
  { text: "Топчик, Настя!", btn: "Я топ!" },
  { text: "Сильно, очень сильно, Настюш", btn: "Спасибо!" },
  { text: "Гордимся тобой, Настюша", btn: "Спасибо!" },
  { text: "Так-так, Настя, кто это у нас тут такая молодец?", btn: "Это я!" },
];
